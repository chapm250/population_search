(ns simple-search.experiment
  (:require [simple-search.core_tweak :as core])
...
(defn -main
  ...
  (print-experimental-results
   (run-experiment [(with-meta
                      (partial core/hill-climb )
                      {:label "hill_climber_cliff_score"})
                    (with-meta
                      (partial core/hill-climb-restart )
                      {:label "hill_climber_restart"})
                    (with-meta
                      (partial core/hill-climb-restart-penalized )
                      {:label "hill_climber_restart-penalized"})
