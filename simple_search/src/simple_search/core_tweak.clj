...
(defn crossover
  ...
  [crossovertype gensyle  max-tries instance]
...
;; (crossover uniform_crossover new-generation  100 100 knapPI_11_20_1000_4)
;(count (new-generation (create-start-population knapPI_16_20_1000_1) 8 knapPI_16_20_1000_1))
...
;; (defn hill-climber [make-answer instance max-tries max-answers]
